...
def drl_train(vsr_set, drl_set, val_set=None, lr=1e-4, epochs=100, batch_size=32, model_path=None):
    ...
    #optimizer = optim.AdamW(model.parameters(), lr=lr, betas=(0.9, 0.98), eps=1e-9, weight_decay=1e-6)
    vsr_optimizer = optim.AdamW(model.parameters(), lr=lr, betas=(0.9, 0.98), eps=1e-9, weight_decay=1e-6)
...
if __name__ == '__main__':
    ...
    drl_train(vsr_set, drl_set, val_set, lr=3e-4, epochs=50, batch_size=32, model_path=None)
    #drl_train(vsr_set, drl_set, val_set, lr=1e-4, epochs=50, batch_size=32, model_path='checkpoints/drl_grid/iter_1.pt')
    #test_set = GRIDDataset(data_root, r'data\unseen_val.json', phase='test')
