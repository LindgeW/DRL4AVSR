...
def load_video(path):
    ...
    if not cap.isOpened():
        ...
        print('FPS:', cap.get(cv2.CAP_PROP_FPS),
              'Frame Num:', cap.get(cv2.CAP_PROP_FRAME_COUNT), 
...
if __name__ == '__main__':
    ...
    #align_video(r"trainval/ZzugJPASNB8/50001.mp4", 'align_faces', 200)
    #align_video(r"trainval/XDBWEKBq0Sw/50001.mp4", 'align_faces', 200)
    #align_video(r"trainval/0af00UcTOSc/50002.mp4", 'align_faces', 200)
    #align_video(r"test/wzkFoetpSSM/00002.mp4", 'align_faces', 200)
    align_video(r"test/zuYzOn0U2PY/00001.mp4", 'align_faces', 200)
